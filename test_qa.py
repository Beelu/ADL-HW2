...
def main():
    ...
    if args.dataset_name is not None:
        ...
        if args.test_file is not None:
            ...
            for i, data in enumerate(test_data):
                ...
                data_values = {'id':data['id'], 'context':artical, 'question':data['question']}
    ...
    for index in random.sample(range(len(test_examples)), 1):
        logger.info(f"Sample {index} of the test set: {test_examples[index]}.")
